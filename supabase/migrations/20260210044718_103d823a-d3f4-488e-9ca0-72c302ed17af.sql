...
INSERT INTO public.treatment_categories (name, slug, icon, description) VALUES
  ('Cardiac Surgery', 'cardiac', '🫀', 'Heart and cardiovascular procedures'),
  ('Orthopedics', 'orthopedics', '🦴', 'Joint replacement, spine surgery, and bone procedures'),
  ('Ophthalmology', 'ophthalmology', '👁️', 'Eye surgery including LASIK and cataract removal'),
  ('Dental Care', 'dental', '🦷', 'Dental implants, veneers, and oral surgery'),
  ('Fertility', 'fertility', '👶', 'IVF, IUI, and reproductive treatments'),
  ('Neurology', 'neurology', '🧠', 'Brain and nervous system procedures'),
  ('Cosmetic Surgery', 'cosmetic', '💆', 'Plastic and reconstructive surgery'),
  ('Other', 'other', '🏥', 'Other medical treatments');